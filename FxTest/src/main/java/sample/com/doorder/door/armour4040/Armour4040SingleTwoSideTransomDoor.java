...
public class Armour4040SingleTwoSideTransomDoor extends Armour4040Door {

	public static final Logger LOGGER = LoggerFactory.getLogger(Armour4040SingleTwoSideTransomDoor.class);
	...
	protected Armour4040SingleTwoSideTransomDoorInnerDecoration innerDecoration;
	protected Armour4040SingleTwoSideTransomDoorOuterDecoration outerDecoration;
	private Platband platband;


	public Armour4040SingleTwoSideTransomDoor() {
		super();
		this.innerDecoration = new Armour4040SingleTwoSideTransomDoorInnerDecoration();
		this.outerDecoration = new Armour4040SingleTwoSideTransomDoorOuterDecoration();
	...
	private void calcPipe40x40() {
		...
		if (this.getY() >= 1000 && this.getY() <= 2550 && this.getX() >= 800 && this.getX() <= 3000
			...
			BigDecimal bd = new BigDecimal((((double)this.getX() + this.getY()) * 2 * 1.1 + 2 * this.getY()) / 1000 * Price.PIPE_40x40.getPriceInUAH());
