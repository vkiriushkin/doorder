...
public class Armour4040SingleTwoSideTransomDoorInnerDecoration extends InnerDecoration {
	...
	public void calcPaintingPF(int x, int y, int x_1) {
		...
		if ((x_1 - 80) >= 500 && (x_1 - 80) <= 960 && (y - 80) >= 1000 && (y - 80) <= 2060) {
		...
		if ((x_1 - 80) >= 500 && (x_1 - 80) <= 960 && (y - 80) > 2060 && (y - 80) <= 2550) {
		...
		if ((x_1 - 80) > 960 && (x_1 - 80) <= 1200 && (y - 80) >= 1000 && (y - 80) <= 2060) {
			BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
					+ ((double)x - x_1) * y * Price.LIST_M2.getPriceInUAH() / 1000000
					+ ((double)x - 80) * (y - 80) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
			bd = bd.setScale(2, RoundingMode.CEILING);
		...
		if ((x_1 - 80) > 960 && (x_1 - 80) <= 1200 && (y - 80) > 2060 && (y - 80) <= 2550) {
			BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
					+ ((double)x - x_1) * y * Price.LIST_M2.getPriceInUAH() / 1000000
					+ ((double)x - 80) * (y - 80) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
			bd = bd.setScale(2, RoundingMode.CEILING);
	...
	public void calcPaintingShagreen(int x, int y, int x_1) {
		...
		if (x_1 - 80 < 500 || x_1 - 80 > 1950 || y - 80 < 1000 || y - 80 > 2550)
			throw new UnsupportedDimensions("Painting PF", y, x);
