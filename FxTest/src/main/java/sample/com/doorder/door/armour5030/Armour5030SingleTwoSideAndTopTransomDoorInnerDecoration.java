...
public class Armour5030SingleTwoSideAndTopTransomDoorInnerDecoration extends InnerDecoration {
    ...
    public void calcPaintingPF(int x, int y, int x_1, int y_1) {
        ...
        if (x_1 - 60 < 500 || x_1 - 60 > 1200 || y_1 - 60 < 1000 || y_1 - 60 > 2450)
            throw new UnsupportedDimensions("Painting PF", y, x);
        LOGGER.info("Painting PF: dimension OK");
        if ((x_1 - 60) >= 500 && (x_1 - 60) <= 950 && (y_1 - 60) >= 1000 && (y_1 - 60) <= 1950) {
        ...
        if ((x_1 - 60) >= 500 && (x_1 - 60) <= 950 && (y_1 - 60) > 1950 && (y_1 - 60) <= 2450) {
        ...
        if ((x_1 - 60) > 1051 && (x_1 - 60) <= 1200 && (y_1 - 60) >= 1000 && (y_1 - 60) <= 1950) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)y - y_1) * x * Price.LIST_M2.getPriceInUAH() / 1000000
                    + ((double)x - x_1) * y_1 * Price.LIST_M2.getPriceInUAH() / 1000000
                    + ((double)x - 60) * (y - 60) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
        ...
        if ((x_1 - 60) > 1051 && (x_1 - 60) <= 1200 && (y_1 - 60) > 1950 && (y_1 - 60) <= 2450) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)y - y_1) * x * Price.LIST_M2.getPriceInUAH() / 1000000
                    + ((double)x - x_1) * y_1 * Price.LIST_M2.getPriceInUAH() / 1000000
                    + ((double)x - 60) * (y - 60) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
    ...
    public void calcPaintingPFWithoutTopSideTransom(int x, int y, int x_1, int y_1) {
        ...
        if ((x_1 - 60) >= 500 && (x_1 - 60) <= 1000 && (y_1 - 60) >= 1000 && (y_1 - 60) <= 2030) {
            BigDecimal bd = new BigDecimal(Price.LIST_1x2.getPriceInUAH()
                    + ((double) x - 60) * (y - 60) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            paintingPF = bd.doubleValue();
        ...
        if ((x_1 - 60) >= 500 && (x_1 - 60) <= 1000 && (y_1 - 60) > 2030 && (y_1 - 60) <= 2450) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double) x - 60) * (y - 60) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            paintingPF = bd.doubleValue();
        ...
        if ((x_1 - 60) > 1000 && (x_1 - 60) <= 1200 && (y_1 - 60) >= 1000 && (y_1 - 60) <= 2030) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double) x - 60) * (y - 60) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            paintingPF = bd.doubleValue();
        ...
        if ((x_1 - 60) > 1000 && (x_1 - 60) <= 1200 && (y_1 - 60) > 2030 && (y_1 - 60) <= 2450) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double) x - 60) * (y - 60) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            paintingPF = bd.doubleValue();
    ...
    public void calcPaintingShagreen(int x, int y, int x_1, int y_1) {
        ...
        if ((x_1 - 60) > 950 && (x_1 - 60) <= 1200 && (y_1 - 60) >= 1000 && (y_1 - 60) <= 1950) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double) y - y_1) * x * Price.LIST_M2.getPriceInUAH() / 1000000
                    + ((double) x - x_1) * y_1 * Price.LIST_M2.getPriceInUAH() / 1000000
                    + ((double) x - 60) * (y - 60) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000000);
        ...
        if ((x_1 - 60) > 950 && (x_1 - 60) <= 1200 && (y_1 - 60) > 1950 && (y_1 - 60) <= 2450) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double) y - y_1) * x * Price.LIST_M2.getPriceInUAH() / 1000000
                    + ((double) x - x_1) * y_1 * Price.LIST_M2.getPriceInUAH() / 1000000
                    + ((double) x - 60) * (y - 60) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000000);
    ...
    public void calcPaintingShagreenWithoutTopSideTransom(int x, int y, int x_1, int y_1) {
        ...
        if ((x_1 - 60) >= 500 && (x_1 - 60) <= 1000 && (y_1 - 60) >= 1000 && (y_1 - 60) <= 2030) {
            BigDecimal bd = new BigDecimal(Price.LIST_1x2.getPriceInUAH()
                    + ((double) x_1 - 60) * (y_1 - 60) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000000
                    + (((double) y - y_1) * x
    ...
    public void calcPaintingAnticWithoutTopSideTransom(int x, int y, int x_1, int y_1) {
        ...
        if ((x_1 - 60) >= 500 && (x_1 - 60) <= 1000 && (y_1 - 60) >= 1000 && (y_1 - 60) <= 2030) {
            BigDecimal bd = new BigDecimal(Price.LIST_1x2.getPriceInUAH()
                    + ((double)x_1 - 60) * (y_1 - 60) * Price.PAINTING_ANTIC.getPriceInUAH() / 1000000
                    + (((double)y - y_1) * x
                    + ((double)x - x_1) * y_1) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            paintingAntic = bd.doubleValue();
    ...
    public void calcMdf10WithoutTopSideTransom(int x, int y, int x_1, int y_1) {
        ...
        if ((y_1 - 30) > 2050 && (y_1 - 30) <= 2350) {
            BigDecimal bd = new BigDecimal(((double) (y_1 - 30) * (x_1 - 30)) / 1000000 * Price.MDF_10.getPriceInUAH() + 40
                    + (((double) y - y_1) * x
                    + ((double)x - x_1) * y_1) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            mdf10 = bd.doubleValue();
    ...
    public void calcMdf16WithoutTopSideTransom(int x, int y, int x_1, int y_1) {
        ...
        if ((y_1 - 30) > 2050 && (y_1 - 30) <= 2350) {
            BigDecimal bd = new BigDecimal(((double) (y_1 - 30) * (x_1 - 30)) / 1000000 * Price.MDF_16.getPriceInUAH() + 40
                    + (((double) y - y_1) * x
                    + ((double)x - x_1) * y_1) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            mdf16 = bd.doubleValue();
