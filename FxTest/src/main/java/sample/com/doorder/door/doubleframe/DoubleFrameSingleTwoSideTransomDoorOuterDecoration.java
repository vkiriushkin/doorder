...
public class DoubleFrameSingleTwoSideTransomDoorOuterDecoration extends OuterDecoration {

    public void calcSelfAdhesiveFilm(int x, int y, int x_1) {
    ...
    public void calcSelfAdhesiveFilmWithoutTopTransom(int x, int y, int x_1) {
        ...
        if (x_1 < 500 || x_1 > 1200)
            throw new UnsupportedDimensions("Self adhesive film, without top transom", y, x_1);
    ...
    public void calcPaintingShagreen(int x, int y, int x_1) {
        ...
        BigDecimal bd = new BigDecimal((((double) x * y) / 1000000
                + ((double)x + y) * 2 * 0.1 / 1000 + ((double)y + x_1) * 2 * 0.16 / 1000 + ((double)x_1 + y) * 2 * 0.13 / 1000) * Price.PAINTING_SHAGREEN.getPriceInUAH());
        bd = bd.setScale(2, RoundingMode.HALF_UP);
    ...
    public void calcPaintingShagreenWithoutTopTransom(int x, int y, int x_1) {
        LOGGER.info("Start calculating outer decoration without top transom");
        clear();
        BigDecimal bd = new BigDecimal((((double) x_1 * y) / 1000000 + ((double)x_1 + y) * 2 * 0.16 / 1000 + ((double)x_1 + y) * 2 * 0.13 / 1000) * Price.PAINTING_SHAGREEN.getPriceInUAH()
                + ((double)x - x_1) * y * Price.PAINTING_PF.getPriceInUAH() / 1000000);
        bd = bd.setScale(2, RoundingMode.HALF_UP);
        paintingShagreen = bd.doubleValue();
        totalOuterDecorationPrice += paintingShagreen;
    ...
    public void calcPaintingAntic(int x, int y, int x_1) {
        ...
        clear();
        BigDecimal bd = new BigDecimal((((double) x * y) / 1000000
                + ((double)x + y) * 2 * 0.1 / 1000 + (y + x_1) * 2 * 0.16 / 1000 + ((double)x_1 + y) * 2 * 0.13 / 1000) * Price.PAINTING_ANTIC.getPriceInUAH());
        bd = bd.setScale(2, RoundingMode.HALF_UP);
    ...
    public void calcPaintingAnticWithoutTopTransom(int x, int y, int x_1) {
        LOGGER.info("Start calculating outer decoration without top transom");
        clear();
        BigDecimal bd = new BigDecimal((((double) x_1 * y) / 1000000 + ((double)x_1 + y) * 2 * 0.16 / 1000 + ((double)x_1 + y) * 2 * 0.13 / 1000) * Price.PAINTING_ANTIC.getPriceInUAH()
                + ((double)x - x_1) * y * Price.PAINTING_PF.getPriceInUAH() / 1000000);
        bd = bd.setScale(2, RoundingMode.HALF_UP);
        paintingAntic = bd.doubleValue();
        totalOuterDecorationPrice += paintingAntic;
    ...
    public void calcPaintingPF(int x, int y, int x_1) {
        ...
        clear();
        BigDecimal bd = new BigDecimal((((double) x * y) / 1000000
                + ((double)x + y) * 2 * 0.1 / 1000 + (y + x_1) * 2 * 0.16 / 1000 + ((double)x_1 + y) * 2 * 0.13 / 1000) * Price.PAINTING_PF.getPriceInUAH());
        bd = bd.setScale(2, RoundingMode.HALF_UP);
    ...
    public void calcPaintingPFWithoutTopTransom(int x, int y, int x_1) {
        LOGGER.info("Start calculating outer decoration without top transom");
        clear();
        BigDecimal bd = new BigDecimal((((double) x_1 * y) / 1000000 + ((double)x_1 + y) * 2 * 0.16 / 1000 + ((double)x_1 + y) * 2 * 0.13 / 1000) * Price.PAINTING_PF.getPriceInUAH()
                + ((double)x - x_1) * y * Price.PAINTING_PF.getPriceInUAH() / 1000000);
        bd = bd.setScale(2, RoundingMode.HALF_UP);
        paintingPF = bd.doubleValue();
        totalOuterDecorationPrice += paintingPF;
    ...
    public void calcAntiLayer(int x, int y, int x_1) {
        LOGGER.info("Start calculating outer decoration");
        clear();
    ...
    public void calcMdf10WithoutTopTransom(int x, int y, int x_1) {
        ...
        if (y > 2050 && y < 2351) {
            BigDecimal bd = new BigDecimal((double) y * x_1 / 1000000 * Price.MDF_10.getPriceInUAH() + 40
                    + ((double)x - x_1) * y * Price.PAINTING_PF.getPriceInUAH() / 1000000
                    + (((double)x + y) * 2 * 0.07) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            mdf10 = bd.doubleValue();
    ...
    public void calcMdf16WithoutTopTransom(int x, int y, int x_1) {
        ...
        if (y > 2050 && y < 2351) {
            BigDecimal bd = new BigDecimal((double)x_1 * y / 1000000 * Price.MDF_16.getPriceInUAH() + 40
                    + ((double)x - x_1) * y * Price.PAINTING_PF.getPriceInUAH() / 1000000
                    + (((double)x + y) * 2 * 0.07) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            mdf16 = bd.doubleValue();
