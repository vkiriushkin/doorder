...
public class OuterDecoration {
    ...
    public void calcPaintingShagreen(int x, int y) {
        LOGGER.info("Start calculating outer decoration");
        clear();
	    BigDecimal bd = new BigDecimal(((double)x * y) / 1000000 + (x + y) * 2 * 0.16 / 1000);
	...
	public void calcPaintingShagreenWithoutTopTransom(int x, int y, int y_1) {
		LOGGER.info("Start calculating outer decoration without top transom");
		clear();
		BigDecimal bd = new BigDecimal(((double)x * y_1) / 1000000 + (x + y_1) * 2 * 0.16 / 1000);
		bd = bd.setScale(2, RoundingMode.HALF_UP);
		paintingShagreen = bd.doubleValue() * Price.PAINTING_SHAGREEN.getPriceInUAH() + (y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000;
		totalOuterDecorationPrice += paintingShagreen;
	...
	public void calcPaintingAnticWithoutTopTransom(int x, int y, int y_1) {
		...
		BigDecimal bd = new BigDecimal(((double)x * y_1) / 1000000 + (x + y_1) * 2 * 0.16 / 1000);
		bd = bd.setScale(2, RoundingMode.HALF_UP);
		paintingAntic = bd.doubleValue() * Price.PAINTING_ANTIC.getPriceInUAH() + (y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000;
		totalOuterDecorationPrice += paintingAntic;
	...
	public void calcPaintingPFWithoutTopTransom(int x, int y, int y_1) {
		...
		BigDecimal bd = new BigDecimal(((double)x * y_1) / 1000000 + (x + y_1) * 2 * 0.16 / 1000);
		bd = bd.setScale(2, RoundingMode.HALF_UP);
		paintingPF = bd.doubleValue() * Price.PAINTING_PF.getPriceInUAH() + (y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000;
		totalOuterDecorationPrice += paintingPF;
    ...
    public void calcMdf10(int x, int y) {
        ...
        if (y > 999 && y < 2051) {
	        ...
	        bd = bd.setScale(2, RoundingMode.HALF_UP);
            mdf10 = bd.doubleValue() * Price.MDF_10.getPriceInUAH() + ((x + y) * 2 * 0.2 * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
            totalOuterDecorationPrice += mdf10;
        }
        if (y > 2050 && y < 2351) {
	        BigDecimal bd = new BigDecimal((double)x * y / 1000000);
	        bd = bd.setScale(2, RoundingMode.HALF_UP);
            mdf10 = bd.doubleValue() * Price.MDF_10.getPriceInUAH() + 40 + ((x + y) * 2 * 0.2 * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
            totalOuterDecorationPrice += mdf10;
        }
	...
	public void calcMdf10WithoutTopTransom(int x, int y, int y_1) {
		...
		if (y_1 > 999 && y_1 < 2051) {
			...
			bd = bd.setScale(2, RoundingMode.HALF_UP);
			mdf10 = bd.doubleValue() * Price.MDF_10.getPriceInUAH() + (y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000 + ((x + y) * 2 * 0.2 * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
			totalOuterDecorationPrice += mdf10;
		}
		if (y_1 > 2050 && y_1 < 2351) {
			BigDecimal bd = new BigDecimal((double)x * y_1 / 1000000);
			bd = bd.setScale(2, RoundingMode.HALF_UP);
			mdf10 = bd.doubleValue() * Price.MDF_10.getPriceInUAH() + 40 + (y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000 + ((x + y) * 2 * 0.2 * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
			totalOuterDecorationPrice += mdf10;
		}
    ...
    public void calcMdf16(int x, int y) {
        ...
        if (y > 999 && y < 2051) {
	        BigDecimal bd = new BigDecimal((double)x * y / 1000000);
	        bd = bd.setScale(2, RoundingMode.HALF_UP);
            mdf16 = bd.doubleValue() * Price.MDF_16.getPriceInUAH() + ((x + y) * 2 * 0.2 * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
            totalOuterDecorationPrice += mdf16;
        }
        if (y > 2050 && y < 2351) {
	        BigDecimal bd = new BigDecimal((double)x * y / 1000000);
	        bd = bd.setScale(2, RoundingMode.HALF_UP);
            mdf16 = bd.doubleValue() * Price.MDF_16.getPriceInUAH() + 40 + ((x + y) * 2 * 0.2 * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
            totalOuterDecorationPrice += mdf16;
        }
	...
	public void calcMdf16WithoutTopTransom(int x, int y, int y_1) {
		...
		if (y_1 > 999 && y_1 < 2051) {
			BigDecimal bd = new BigDecimal((double)x * y_1 / 1000000);
			bd = bd.setScale(2, RoundingMode.HALF_UP);
			mdf16 = bd.doubleValue() * Price.MDF_16.getPriceInUAH() + (y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000 + ((x + y) * 2 * 0.2 * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
			totalOuterDecorationPrice += mdf16;
		}
		if (y_1 > 2050 && y_1 < 2351) {
			BigDecimal bd = new BigDecimal((double)x * y_1 / 1000000);
			bd = bd.setScale(2, RoundingMode.HALF_UP);
			mdf16 = bd.doubleValue() * Price.MDF_16.getPriceInUAH() + 40 + (y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000 + ((x + y) * 2 * 0.2 * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
			totalOuterDecorationPrice += mdf16;
		}
