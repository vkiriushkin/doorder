...
public class AngledDoubleFrameOuterDecoration extends OuterDecoration{

    public static final Logger LOGGER = LoggerFactory.getLogger(AngledDoubleFrameOuterDecoration.class);
    ...
    public AngledDoubleFrameOuterDecoration() {
    }
