...
public class Armour5030SingleTwoSideTransomDoor extends Armour5030Door {

    public static final Logger LOGGER = LoggerFactory.getLogger(Armour5030SingleTwoSideTransomDoor.class);
    ...
    protected Armour5030SingleTwoSideTransomDoorInnerDecoration innerDecoration;
    protected Armour5030SingleTwoSideTransomDoorOuterDecoration outerDecoration;
    private Armour5030DoorPlatband platband;


    public Armour5030SingleTwoSideTransomDoor() {
        super();
        this.innerDecoration = new Armour5030SingleTwoSideTransomDoorInnerDecoration();
        this.outerDecoration = new Armour5030SingleTwoSideTransomDoorOuterDecoration();
    ...
    private void calcPipe50x30() {
        ...
        if (this.getY() >= 1000 && this.getY() <= 2450 && this.getX() >= 800 && this.getX() <= 3000
                && this.getX_1() >= 500 && this.getX_1() <= 1200) {
            LOGGER.info("Pipe 50x30: Dimensions OK");
            BigDecimal bd = new BigDecimal((((double)this.getX() + this.getY()) * 4 * 1.1 + (4 * this.getY() + 2 * x_1) * 1.1) / 1000 * Price.PIPE_50x30.getPriceInUAH());
