...
public class DoubleDoorTopTransomOuterDecoration extends SingleDoorTopSideTransomOuterDecoration {
	...
	public void calcSelfAdhesiveFilm(int x, int y, int x_1, int y_1) {
		...
		if (x >= 800 && x <= 1200) {
			BigDecimal bd = new BigDecimal(1.1 * 1.5 * (double)y / 1000 * Price.SELF_ADHESIVE_FILM.getPriceInUAH() + (((double)x + y) * 2 * 0.1 + ((double)x_1 + 2 * y_1) * 2 * 0.08) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
			bd = bd.setScale(2, RoundingMode.HALF_UP);
			selfAdhesiveFilm = bd.doubleValue();
			totalOuterDecorationPrice += selfAdhesiveFilm;
		}
		if (x >= 1201 && x <= 1400) {
			BigDecimal bd = new BigDecimal(1.1 * 2 * (double)y / 1000 * Price.SELF_ADHESIVE_FILM.getPriceInUAH() + (((double)x + y) * 2 * 0.1 + ((double)x_1 + 2 * y_1) * 2 * 0.08) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
			bd = bd.setScale(2, RoundingMode.HALF_UP);
			selfAdhesiveFilm = bd.doubleValue();
			totalOuterDecorationPrice += selfAdhesiveFilm;
		}
		if (x >= 1401 && x <= 1950) {
			BigDecimal bd = new BigDecimal(1.1 * 3 * y / 1000 * Price.SELF_ADHESIVE_FILM.getPriceInUAH() + (((double)x + y) * 2 * 0.1 + ((double)x_1 + 2 * y_1) * 2 * 0.08) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
			bd = bd.setScale(2, RoundingMode.HALF_UP);
			selfAdhesiveFilm = bd.doubleValue();
			totalOuterDecorationPrice += selfAdhesiveFilm;
		}
	...
	public void calcPaintingShagreen(int x, int y, int x_1, int y_1) {
		LOGGER.info("Start calculating outer decoration");
		clear();
		BigDecimal bd = new BigDecimal((((double) x * y) / 1000000 + ((double)x + y) * 2 * 0.1 / 1000 + (2 * (double)y_1 + x) * 2 * 0.08 / 1000) * Price.PAINTING_SHAGREEN.getPriceInUAH());
		bd = bd.setScale(2, RoundingMode.HALF_UP);
	...
	public void calcPaintingAntic(int x, int y, int x_1, int y_1) {
		LOGGER.info("Start calculating outer decoration");
		clear();
		BigDecimal bd = new BigDecimal((((double) x * y) / 1000000 + ((double)x + y) * 2 * 0.1 / 1000 + (2 * (double)y_1 + x) * 2 * 0.08 / 1000) * Price.PAINTING_ANTIC.getPriceInUAH());
		bd = bd.setScale(2, RoundingMode.HALF_UP);
	...
	public void calcPaintingPF(int x, int y, int x_1, int y_1) {
		LOGGER.info("Start calculating outer decoration");
		clear();
		BigDecimal bd = new BigDecimal((((double) x * y) / 1000000 + ((double)x + y) * 2 * 0.1 / 1000 + (2 * (double)y_1 + x) * 2 * 0.08 / 1000) * Price.PAINTING_PF.getPriceInUAH());
		bd = bd.setScale(2, RoundingMode.HALF_UP);
	...
	public void calcAntiLayer(int x, int y, int x_1, int y_1) {
		...
		if (x >= 800 && x <= 1200) {
			BigDecimal bd = new BigDecimal(1.25 * (double)y / 1000 * Price.ANTI_LAYER.getPriceInUAH()
					+ (((double)x + y) * 2 * 0.1 + (2 * (double)y_1 + x_1) * 2 * 0.08) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
			bd = bd.setScale(2, RoundingMode.HALF_UP);
	...
	public void calcMdf10(int x, int y, int x_1, int y_1) {
		...
		if (y_1 >= 100 && y_1 <= 2050) {
			BigDecimal bd = new BigDecimal((double) x * y / 1000000 * Price.MDF_10.getPriceInUAH() + (((double)x + y) * 2 * 0.1 + (2 * (double)y_1 + x_1) * 2 * 0.08) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
			bd = bd.setScale(2, RoundingMode.HALF_UP);
			mdf10 = bd.doubleValue();
			totalOuterDecorationPrice += mdf10;
		}
		if (y_1 > 2050 && y_1 <= 2350) {
			BigDecimal bd = new BigDecimal((double) x * y / 1000000 * Price.MDF_10.getPriceInUAH() + 80 + (((double)x + y) * 2 * 0.1 + (2 * (double)y_1 + x_1) * 2 * 0.08) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
			bd = bd.setScale(2, RoundingMode.HALF_UP);
			mdf10 = bd.doubleValue();
			totalOuterDecorationPrice += mdf10;
		}
	...
	public void calcMdf16(int x, int y, int x_1, int y_1) {
		...
		if (y_1 >= 1000 && y_1 <= 2050) {
			BigDecimal bd = new BigDecimal((double) x * y / 1000000 * Price.MDF_16.getPriceInUAH() + (((double)x + y) * 2 * 0.1 + (2 * (double)y_1 + x_1) * 2 * 0.08) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
			bd = bd.setScale(2, RoundingMode.HALF_UP);
			mdf16 = bd.doubleValue();
			totalOuterDecorationPrice += mdf16;
		}
		if (y_1 >= 2051 && y_1 <= 2350) {
			BigDecimal bd = new BigDecimal((double) x * y / 1000000 * Price.MDF_16.getPriceInUAH() + 80 + (((double)x + y) * 2 * 0.1 + (2 * (double)y_1 + x_1) * 2 * 0.08) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000);
			bd = bd.setScale(2, RoundingMode.HALF_UP);
			mdf16 = bd.doubleValue();
			totalOuterDecorationPrice += mdf16;
		}
	...
	public void calcPaintingShagreenWithoutTopSideTransom(int x, int y, int x_1, int y_1) {
		LOGGER.info("Start calculating outer decoration without top transom");
		clear();
		BigDecimal bd = new BigDecimal((((double) y_1 * x) / 1000000 + (x + y_1) * 2 * 0.1 / 1000 + (4 * y_1 + 2 * x) * 0.06 / 1000) * Price.PAINTING_SHAGREEN.getPriceInUAH()
				+ (((double) y - y_1) * x) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
		bd = bd.setScale(2, RoundingMode.HALF_UP);
		paintingShagreen = bd.doubleValue();
		totalOuterDecorationPrice += paintingShagreen;
	...
	public void calcPaintingAnticWithoutTopSideTransom(int x, int y, int x_1, int y_1) {
		LOGGER.info("Start calculating outer decoration without top transom");
		clear();
		BigDecimal bd = new BigDecimal((((double) y_1 * x) / 1000000 + (x + y_1) * 2 * 0.1 / 1000 + (4 * y_1 + 2 * x) * 0.06 / 1000) * Price.PAINTING_ANTIC.getPriceInUAH()
				+ (((double) y - y_1) * x) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
		bd = bd.setScale(2, RoundingMode.HALF_UP);
		paintingAntic = bd.doubleValue();
		totalOuterDecorationPrice += paintingAntic;
	...
	public void calcPaintingPFWithoutTopSideTransom(int x, int y, int x_1, int y_1) {
		LOGGER.info("Start calculating outer decoration without top transom");
		clear();
		BigDecimal bd = new BigDecimal((((double) y_1 * x) / 1000000 + (x + y_1) * 2 * 0.1 / 1000 + (4 * y_1 + 2 * x) * 0.06 / 1000) * Price.PAINTING_PF.getPriceInUAH() + (((double) y - y_1) * x) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
		bd = bd.setScale(2, RoundingMode.HALF_UP);
		paintingPF = bd.doubleValue();
		totalOuterDecorationPrice += paintingPF;
