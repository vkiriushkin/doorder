...
public class Armour5030SingleTopTransomDoorInnerDecoration extends InnerDecoration {
    ...
    public void calcMdf10WithoutTopTransom(int x, int y, int y_1) {
        ...
        if ((y_1 - 30) >=1000 && (y_1 - 30) <= 2050) {
            BigDecimal bd = new BigDecimal(((double)x - 30) * (y_1 - 30) / 1000000 * Price.MDF_10.getPriceInUAH()
                    + ((double)y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            mdf10 = bd.doubleValue();
            totalInnerDecorationPrice += mdf10;
        ...
        if ((y_1 - 30) > 2050 && (y_1 - 30) <= 2350) {
            BigDecimal bd = new BigDecimal(((double)x - 30) * (y_1 - 30) / 1000000 * Price.MDF_10.getPriceInUAH() + 40
                    + ((double)y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            mdf10 = bd.doubleValue();
            totalInnerDecorationPrice += mdf10;
    ...
    public void calcMdf16WithoutTopTransom(int x, int y, int y_1) {
        ...
        if ((y_1 - 30) >=1000 && (y_1 - 30) <= 2050) {
            BigDecimal bd = new BigDecimal(((double)x - 30) * (y_1 - 30) / 1000000 * Price.MDF_16.getPriceInUAH()
                    + ((double)y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            mdf16 = bd.doubleValue();
            totalInnerDecorationPrice += mdf16;
        ...
        if ((y_1 - 30) > 2050 && (y_1 - 30) <= 2350) {
            BigDecimal bd = new BigDecimal(((double)x - 30) * (y_1 - 30) / 1000000 * Price.MDF_16.getPriceInUAH() + 40
                    + ((double)y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            mdf16 = bd.doubleValue();
            totalInnerDecorationPrice += mdf16;
    ...
    public void calcPaintingPF(int x, int y, int y_1) {
        ...
        if ((x - 30) > 1000 && (x - 30) <= 1200 && (y_1 - 30) >=1000 && (y_1 - 30) <= 2030) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)x - 30) * (y - 30) * Price.PAINTING_PF.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x / 1000000 * Price.LIST_M2.getPriceInUAH());
            bd = bd.setScale(2, RoundingMode.HALF_UP);
        ...
        if ((x - 30) > 1000 && (x - 30) <= 1200 && (y - 30) > 2030 && (y - 30) <= 2450) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)x - 30) * (y - 30) * Price.PAINTING_PF.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x / 1000000 * Price.LIST_M2.getPriceInUAH());
            bd = bd.setScale(2, RoundingMode.HALF_UP);
    ...
    public void calcPaintingPFWithoutTopTransom(int x, int y, int y_1) {
        ...
        if ((x - 30) >= 500 && (x - 30) <= 1000 && (y_1 - 30) >=1000 && (y_1 - 30) <= 2030) {
            BigDecimal bd = new BigDecimal(Price.LIST_1x2.getPriceInUAH()
                    + ((double)x - 30) * (y_1 - 30) * Price.PAINTING_PF.getPriceInUAH() / 1000000
    ...
    public void calcPaintingShagreen(int x, int y, int y_1) {
        ...
        if ((x - 30) >= 500 && (x - 30) <= 1000 && (y_1 - 30) >=1000 && (y_1 - 30) <= 2030) {
            BigDecimal bd = new BigDecimal(Price.LIST_1x2.getPriceInUAH()
                    + ((double)x - 30) * (y_1 - 30) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x / 1000000 * Price.LIST_M2.getPriceInUAH()
                    + ((double)y - y_1) * x / 1000000 * Price.PAINTING_PF.getPriceInUAH());
            bd = bd.setScale(2, RoundingMode.HALF_UP);
        ...
        if ((x - 30) > 1000 && (x - 30) <= 1200 && (y_1 - 30) > 2030 && (y_1 - 30) <= 2450) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)x - 30) * (y_1 - 30) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x / 1000000 * Price.LIST_M2.getPriceInUAH()
                    + ((double)y - y_1) * x / 1000000 * Price.PAINTING_PF.getPriceInUAH());
    ...
    public void calcPaintingShagreenWithoutTopTransom(int x, int y, int y_1) {
        ...
        if ((x - 30) >= 500 && (x - 30) <= 1000 && (y_1 - 30) > 2030 && (y_1 - 30) <= 2450) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)x - 30) * (y - 30) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x / 1000000 * Price.PAINTING_PF.getPriceInUAH());
            bd = bd.setScale(2, RoundingMode.HALF_UP);
            paintingShagreen = bd.doubleValue();
            totalInnerDecorationPrice += paintingShagreen;
    ...
    public void calcPaintingAntic(int x, int y, int y_1) {
        ...
        if ((x - 30) >= 500 && (x - 30) <= 1000 && (y_1 - 30) >=1000 && (y_1 - 30) <= 2030) {
            BigDecimal bd = new BigDecimal(Price.LIST_1x2.getPriceInUAH()
                    + ((double)x - 30) * (y_1 - 30) * Price.PAINTING_ANTIC.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x / 1000000 * Price.LIST_M2.getPriceInUAH()
                    + ((double)y - y_1) * x / 1000000 * Price.PAINTING_PF.getPriceInUAH());
            bd = bd.setScale(2, RoundingMode.HALF_UP);
