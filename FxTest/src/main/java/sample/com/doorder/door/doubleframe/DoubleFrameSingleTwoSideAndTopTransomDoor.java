...
public class DoubleFrameSingleTwoSideAndTopTransomDoor extends DoubleFrameDoor {

    public static final Logger LOGGER = LoggerFactory.getLogger(DoubleFrameSingleTwoSideAndTopTransomDoor.class);
    ...
    protected DoubleFrameSingleTwoSideAndTopTransomInnerDecoration innerDecoration;
    protected DoubleFrameSingleTwoSideAndTopTransomDoorOuterDecoration outerDecoration;


    public DoubleFrameSingleTwoSideAndTopTransomDoor() {
        super();
    ...
    private void calcPipe50x30() {
        ...
        if (this.getY() >= 1000 && this.getY() <= 3000 && this.getX() >= 800 && this.getX() <= 3000
            ...
            BigDecimal bd = new BigDecimal(((double)this.getX_1() + this.getY_1()) * 2 / 1000 * Price.PIPE_50x30.getPriceInUAH());
            bd = bd.setScale(2, RoundingMode.HALF_UP);
    ...
    private void calcPipe25x25() {
        ...
        if (this.getY() >= 1000 && this.getY() <= 3000 && this.getX() >= 800 && this.getX() <= 3000
            ...
            BigDecimal bd = new BigDecimal(((double) this.getX_1() + this.getY_1()) * 2.2 / 1000 * Price.PIPE_25x25.getPriceInUAH());
            bd = bd.setScale(2, RoundingMode.HALF_UP);
    ...
    public void calcSeal(boolean sealNeeded) {
        BigDecimal bd = new BigDecimal(((double)this.getX_1() + this.getY_1()) * 4 * 1.1 / 1000 * Price.SEAL.getPriceInUAH());
        bd = bd.setScale(2, RoundingMode.HALF_UP);
