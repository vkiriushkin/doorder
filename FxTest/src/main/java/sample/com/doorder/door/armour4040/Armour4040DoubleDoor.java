...
public class Armour4040DoubleDoor extends Armour4040Door {

	public static final Logger LOGGER = LoggerFactory.getLogger(Armour4040DoubleDoor.class);
	public static final int HINGE_NUMBER = 4;

	protected int x_1;
	protected Armour4040DoubleDoorInnerDecoration innerDecoration;
	protected Armour4040DoubleDoorOuterDecoration outerDecoration;
	private Platband platband;

	public Armour4040DoubleDoor() {
		super();
		this.innerDecoration = new Armour4040DoubleDoorInnerDecoration();
		this.outerDecoration = new Armour4040DoubleDoorOuterDecoration();
	...
	public void calcMetalList() {
		...
		} else if (this.getY() >= 2031 && this.getY() <= 2550
				&& this.getX() >= 800 && this.getX() <= 1000) {
			LOGGER.info("Metal list: Dimensions OK");
