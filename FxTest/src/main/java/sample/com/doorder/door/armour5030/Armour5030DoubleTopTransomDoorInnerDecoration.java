...
public class Armour5030DoubleTopTransomDoorInnerDecoration extends InnerDecoration {
    ...
    public void calcPaintingPF(int x, int y, int x_1, int y_1) {
        ...
        if (x - 60 < 800 || x - 60 > 2000 || y_1 - 60 < 1000 || y_1 - 60 > 2450)
            throw new UnsupportedDimensions("Painting PF", y, x);
        LOGGER.info("Painting PF: dimension OK");
        if ((x - 60) >= 800 && (x - 60) <= 950 && (y_1 - 60) >= 1000 && (y_1 - 60) <= 2000) {
        ...
        if ((x - 60) >= 800 && (x - 60) <= 950 && (y_1 - 60) > 2000 && (y_1 - 60) <= 2450) {
        ...
        if ((x - 60) > 951 && (x - 60) <= 1200 && (y_1 - 60) >= 1000 && (y_1 - 60) <= 2000) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)x - 60) * (y - 60) * Price.PAINTING_PF.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x * Price.LIST_M2.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
        ...
        if ((x - 60) > 951 && (x - 60) <= 1200 && (y_1 - 60) > 2000 && (y_1 - 60) <= 2450) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)x - 60) * (y - 60) * Price.PAINTING_PF.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x * Price.LIST_M2.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
        ...
        if ((x - 60) > 1200 && (x - 60) <= 2000 && (y_1 - 60) >= 1000 && (y_1 - 60) <= 2000) {
        ...
        if ((x - 60) > 1200 && (x - 60) <= 2000 && (y_1 - 60) > 2000 && (y_1 - 60) <= 2450) {
            BigDecimal bd = new BigDecimal(1.5 * Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)x - 60) * (y - 60) * Price.PAINTING_PF.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x * Price.LIST_M2.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
    ...
    public void calcPaintingPFWithoutTopSideTransom(int x, int y, int x_1, int y_1) {
        ...
        if ((x - 60) >= 800 && (x - 60) <= 1000 && (y_1 - 60) >= 1000 && (y_1 - 60) <= 2030) {
            BigDecimal bd = new BigDecimal(Price.LIST_1x2.getPriceInUAH()
        ...
        if ((x - 60) >= 800 && (x - 60) <= 1000 && (y_1 - 60) > 2060 && (y_1 - 60) <= 2450) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)x - 60) * (y_1 - 60) * Price.PAINTING_PF.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
        ...
        if ((x - 60) > 1200 && (x - 60) <= 2000 && (y_1 - 60) >= 1000 && (y_1 - 60) <= 2030) {
            BigDecimal bd = new BigDecimal(1.5 * Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)x - 60) * (y_1 - 60) * Price.PAINTING_PF.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
        ...
        if ((x - 60) > 1200 && (x - 60) <= 2000 && (y_1 - 60) > 2030 && (y_1 - 60) <= 2450) {
            BigDecimal bd = new BigDecimal(1.5 * Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)x - 60) * (y_1 - 60) * Price.PAINTING_PF.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x * Price.PAINTING_PF.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
    ...
    public void calcPaintingShagreenWithoutTopSideTransom(int x, int y, int x_1, int y_1) {
        ...
        if ((x - 60) >= 800 && (x - 60) <= 1000 && (y_1 - 60) > 2030 && (y_1 - 60) <= 2450) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH()
                    + ((double)x - 60) * (y_1 - 60) * Price.PAINTING_SHAGREEN.getPriceInUAH() / 1000000
                    + ((double)y - y_1) * x * Price.LIST_M2.getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.HALF_UP);
