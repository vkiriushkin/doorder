...
public class DoubleFrameSingleTwoSideTransomDoor extends DoubleFrameDoor {

    public static final Logger LOGGER = LoggerFactory.getLogger(DoubleFrameSingleTwoSideTransomDoor.class);
    public static final int HINGE_NUMBER = 2;

    private DoubleFrameSingleTwoSideTransomDoorInnerDecoration innerDecoration;
    private DoubleFrameSingleTwoSideTransomDoorOuterDecoration outerDecoration;
    ...
    private void calcPipe40x20() {
        ...
        if (this.getY() >= 1000 && this.getY() <= 2450 && this.getX() >= 800 && this.getX() <= 3000
            ...
            BigDecimal bd = new BigDecimal(((double)this.getX_1() + this.getY()) * 2 / 1000 * Price.PIPE_40x20.getPriceInUAH());
            bd = bd.setScale(2, RoundingMode.HALF_UP);
