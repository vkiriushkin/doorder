...
public class DoubleFrameSingleTopTransomDoorOuterDecoration extends DoubleFrameAngledDoorOuterDecoration {
    ...
    public void calcPaintingShagreen(int x, int y, int y_1) {
        ...
        BigDecimal bd = new BigDecimal((((double) x * y) / 1000000
                ...
                + ((double)x + y_1) * 2 * 0.07 / 1000) * Price.PAINTING_SHAGREEN.getPriceInUAH());
        bd = bd.setScale(2, RoundingMode.HALF_UP);
    ...
    public void calcPaintingAntic(int x, int y, int y_1) {
        ...
        BigDecimal bd = new BigDecimal((((double) x * y) / 1000000
                + ((double)x + y) * 2 * 0.16 / 1000
                + ((double)x + y_1) * 2 * 0.07 / 1000) * Price.PAINTING_ANTIC.getPriceInUAH());
        bd = bd.setScale(2, RoundingMode.HALF_UP);
    ...
    public void calcPaintingPF(int x, int y, int y_1) {
        ...
        BigDecimal bd = new BigDecimal((((double) x * y) / 1000000
                + ((double)x + y) * 2 * 0.16 / 1000
                + ((double)x + y_1) * 2 * 0.07 / 1000) * Price.PAINTING_PF.getPriceInUAH());
        bd = bd.setScale(2, RoundingMode.HALF_UP);
