...
public class DoubleDoorInnerDecoration extends InnerDecoration {
    ...
    public void calcPlastic(int x, int y) {
        ...
        clear();
        plastic = (2 * x + 4 * y) * 1.1 * Price.START.getPriceInUAH() / 1000 + ((double)x * y) * 1.1 * Price.PLASTIC.getPriceInUAH() / 1000000;
    ...
    public void calcLaminate(int x, int y) {
        LOGGER.info("Start calculating inner decoration");
        clear();
        BigDecimal bd = new BigDecimal((2 * x + 4 * y) * 1.1 * Price.START.getPriceInUAH() / 1000 + ((double)x * y) * 1.1 * Price.LAMINATED_PLASTIC.getPriceInUAH() / 1000000);
    ...
    public void calcPaintingPF(int x, int y) {
        ...
        if ((x - 50) >= 800 && (x - 50) <= 950 && (y - 50) >= 1000 && (y - 50) <= 2030) {
            BigDecimal bd = new BigDecimal(Price.LIST_1x2.getPriceInUAH() + (x - 50) * (y - 50) * Price.PAINTING_PF.getPriceInUAH() / 1000000);
    ...
    public void calcPaintingShagreen(int x, int y) {
        ...
        if ((x - 50) >= 800 && (x - 50) <= 950 && (y - 50) >= 2031 && (y - 50) <= 2450) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH() + ((double)x - 50) * (y - 50) * Price.PAINTING_SHAGREEN
                    .getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.CEILING);
            paintingShagreen = bd.doubleValue();
            totalInnerDecorationPrice += paintingShagreen;
        ...
        if ((x - 50) >= 1201 && (x - 50) <= 1950 && (y - 50) >= 1000 && (y - 50) <= 2030) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH() * 1.5 + ((double)x - 50) * (y - 50) * Price.PAINTING_SHAGREEN
                    .getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.CEILING);
            paintingShagreen = bd.doubleValue();
            totalInnerDecorationPrice += paintingShagreen;
    ...
    public void calcPaintingAntic(int x, int y) {
        ...
        if ((x - 50) >= 800 && (x - 50) <= 950 && (y - 50) >= 2031 && (y - 50) <= 2450) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH() + ((double)x - 50) * (y - 50) * Price.PAINTING_ANTIC
                    .getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.CEILING);
            paintingAntic = bd.doubleValue();
            totalInnerDecorationPrice += paintingAntic;
        ...
        if ((x - 50) >= 1201 && (x - 50) <= 1950 && (y - 50) >= 1000 && (y - 50) <= 2030) {
            BigDecimal bd = new BigDecimal(Price.LIST_1_25x2_5.getPriceInUAH() * 1.5 + ((double)x - 50) * (y - 50) * Price.PAINTING_ANTIC
                    .getPriceInUAH() / 1000000);
            bd = bd.setScale(2, RoundingMode.CEILING);
            paintingAntic = bd.doubleValue();
            totalInnerDecorationPrice += paintingAntic;
