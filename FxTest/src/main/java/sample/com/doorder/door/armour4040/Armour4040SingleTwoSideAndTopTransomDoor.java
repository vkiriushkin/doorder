...
public class Armour4040SingleTwoSideAndTopTransomDoor extends Armour4040Door {

	public static final Logger LOGGER = LoggerFactory.getLogger(Armour4040SingleTwoSideAndTopTransomDoor.class);
	...
	protected Armour4040SingleTwoSideAndTopTransomDoorInnerDecoration innerDecoration;
	protected Armour4040SingleTwoSideAndTopTransomDoorOuterDecoration outerDecoration;
	private Platband platband;


	public Armour4040SingleTwoSideAndTopTransomDoor() {
		super();
		this.innerDecoration = new Armour4040SingleTwoSideAndTopTransomDoorInnerDecoration();
		this.outerDecoration = new Armour4040SingleTwoSideAndTopTransomDoorOuterDecoration();
	...
	private void calcPipe40x40() {
		...
		if (this.getY() >= 1000 && this.getY() <= 3000 && this.getX() >= 800 && this.getX() <= 3000
			...
			BigDecimal bd = new BigDecimal((((double)this.getX() + this.getY()) * 2 * 1.1 + this.getX() + 2 * this.getY_1()) / 1000 * Price.PIPE_40x40.getPriceInUAH());
	...
	private void calcPipe40x20() {
		...
		if (this.getY() >= 1000 && this.getY() <= 3000 && this.getX() >= 800 && this.getX() <= 3000
			...
			BigDecimal bd = new BigDecimal((((double)this.getX_1() + this.getY_1()) * 2 * 1.1) / 1000 * Price.PIPE_40x20.getPriceInUAH());
			bd = bd.setScale(2, RoundingMode.HALF_UP);
