...
public class Armour5030DoubleTopTransomDoor extends Armour5030Door {

    public static final Logger LOGGER = LoggerFactory.getLogger(Armour5030DoubleTopTransomDoor.class);
    ...
    protected Armour5030DoubleTopTransomDoorInnerDecoration innerDecoration;
    protected Armour5030DoubleTopTransomDoorOuterDecoration outerDecoration;
    private Armour5030DoorPlatband platband;


    public Armour5030DoubleTopTransomDoor() {
        super();
    ...
    private void calcPipe50x30() {
        ...
        if (this.getX() >= 800 && this.getX() <= 2000
            ...
            BigDecimal bd = new BigDecimal((((double)this.getX() + this.getY()) * 4 * 1.1 + (4 * y_1 + 3 * this.getX()) * 1.1) / 1000 * Price.PIPE_50x30.getPriceInUAH());
